namespace CMA.SAU.AzureFunctions
{
    internal class Constants
    {
        ...
        internal const string UNIQUE_ID = "SAURequestUniqueID";
        ...
        internal const string SITE_URL = "SiteURL";
        ...
        internal const string SAU_EXTERNAL_MAILBOX_ID = "SAUExternalMailboxID";
        internal const string SAU_PIPELINE_OWNERS = "SAUPipelineOwners";
        internal const string SAU_PIPELINE_MEMBERS = "SAUPipelineMembers";
    }
}